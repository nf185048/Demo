...
import { Modal, Button, Grid, Input, InputWrapper, Label, FormLabel, Radio, RadioGroup } from '@ncr-design-system/react'
...
export const ModalExample: FC<{}> = ({ children }) => {
  ...
  return (
    <div>
      <p>Modals</p>
      <Modal width='400px' open={opened} onHide={() => setOpened(false)}>
